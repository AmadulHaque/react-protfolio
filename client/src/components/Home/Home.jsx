                    ...
                    <div
                        ...
                        <div>
                            <img
                                ...
                                alt="my picture"
                            />
                            <h6 className="pl-3 text-uppercase open-sans-font mb-0 d-block d-sm-none d-lg-block">
                                hi there !
                            </h6>
                            <h1 className="pl-3 text-uppercase poppins-font">
                                <span>I'm</span> steve milner
                            </h1>
                            <p className="pl-3 open-sans-font">
                                I'm a Tunisian based web designer &amp; front‑end developer focused on
                                crafting clean &amp; user‑friendly experiences, I am passionate about
                                building excellent software that improves the lives of those around
                                me.
                            </p>
                            <a href="about.html" className="ml-3 btn btn-about">
                                more about me
                            </a>
                        </div>
                    </div>
